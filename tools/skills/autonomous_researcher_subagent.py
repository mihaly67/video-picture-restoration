...
def autonomous_research(topic: str, max_iterations: int = 3):
    ...
    interrogator_path = os.path.join(script_dir, "RAG_building", "rag_interrogator.py")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--topic", required=True, help="A kutatandó téma (pl. 'FaceFusion frame processing')")
